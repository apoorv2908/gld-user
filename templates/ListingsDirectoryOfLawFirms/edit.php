...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $listingsDirectoryOfLawFirm->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $listingsDirectoryOfLawFirm->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="listingsDirectoryOfLawFirms form content">
            ...
            <fieldset>
                <legend><?= __('Edit Listings Directory Of Law Firm') ?></legend>
                <?php
