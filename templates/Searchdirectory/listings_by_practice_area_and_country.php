    ...
    <?= $this->element('header') ?>
      ...
      <div class="text-center">
        <div class="breadcrumbs">
          <h1 class="font36 text-white font30-sm fw-bold text-uppercase"> <span id="Headername1">                                   <?= h($practiceAreaTitle) ?>: Lawyers and Law Firms in <?= h($countryName) ?>
          </span></h1>
        </div>
      </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="practice_area">Select a Practice Area</label>
                <?= $this->Form->control('practice_area', [
                    ...
                    'default' => $practiceAreaId, // Set selected practice area
                    'class' => 'form-control',
                    'label' => false
                ]) ?>
            </div>
            ...
            <!-- State Filter -->
            <div class="form-group">
                <label for="state_id">Select a State</label>
                <?= $this->Form->control('state_id', [
                    'type' => 'select',
                    'options' => $statesList, // States for the selected country
                    'empty' => 'All States',
                    'default' => $stateId, // Set selected state if any
                    'class' => 'form-control',
                    'label' => false
                ]) ?>
            </div>
